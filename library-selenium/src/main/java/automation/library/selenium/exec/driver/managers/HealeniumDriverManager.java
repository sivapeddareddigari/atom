...
public class HealeniumDriverManager extends DriverManager {

    protected Logger log = LogManager.getLogger(this.getClass().getName());



    public void createDriver(WebDriver driverToWrap) {
        log.debug("Initiation of SelfHealingDriver");
        driver = SelfHealingDriver.create(driverToWrap);
    }

    /*
    *To be Implemented as parametrise wrapper around any driver
    *
    *  */
    @Override
